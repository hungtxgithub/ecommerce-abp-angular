...
public static class EcommerceAbpFrameworkEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EcommerceAbpFrameworkModuleExtensionConfigurator CLASS (in the Domain.Shared project)
